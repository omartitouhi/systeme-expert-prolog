% Le système expert doit être démarré à partir d ici
...
% Stockez les réponses des utilisateurs pour pouvoir suivre sa progression

:- dynamic(progress/2).

% Effacer la progression de l utilisateur stocké 
%reset_answers doit toujours renvoyer true; 
%parce que retract peut retourner soit vrai soit faux,
%nous échouons le premier et réussissons avec le second.
...
% Les règles pour la base de connaissances.
...
% Les questions pour la base de connaissances.
...
% Les réponses pour la base de connaissances
...
% Les descriptions linguistiques pour la base de connaissances
...
% Les attribue une réponse aux questions de la base de connaissances
...
% Liste des réponses 
% [First|Rest] est la liste des choix, Index est l indice de First dans les choix
...
% Analyse l index et renvoie une réponse représentant l élément "Indexth" dans les choix (the [First|Rest] list)
...
% Pose la question à l utilisateur et enregistre la réponse
